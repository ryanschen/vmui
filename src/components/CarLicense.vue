<template>
  <div ref="keyboardWrapper" class="car-license-wrapper">
    <div class="content-wrapper" v-show="!$slots.input">
      ...
      <div class="energy" :class="{'has-energy-text': hasEnergyText}">
        <span
          ...
          :class="{
            'blink-blur':keyBoardDisplay === 'none',
            'hidden-placeholder':carNumber
          }"
    ...
    <transition name="ry-slide-bottom">
      <div class="en-num-wrapper" v-show="keyBoardDisplay === 'block'" @click="getContent($event)">
        <p class="close-btn"><a @click="closeEnNumKeyboard($event)">{{ closeBtnText }}</a></p>
        <ul class="row-key" v-for="(item, index) in keyboardList" :key="index">
          <template v-if="index === 0">
            <li v-for="(item, index) in item" :key="'num-' + index" :class="{ disabled: isNumKeyDisabled }">{{ item }}</li>
          </template>
          <template v-else-if="index === 1">
            <li v-for="(item, index) in item" :key="'firstRow-' + index">{{ item }}</li>
            <li :class="{ disabled: isEnKeyDisabled }">I</li>
            <li :class="{ disabled: isEnKeyDisabled }">O</li>
            <li>P</li>
          </template>
          <template v-else-if="index === 2">
            <li v-for="(item, index) in item" :key="'secondRow-' + index">{{ item }}</li>
          </template>
          <template v-else-if="index === 3">
            <li class="uppercase disabled iconfont icon-xiangshang icon-keyboard-xiangshang"></li>
            <li v-for="(item, index) in item" :key="'threeRow-' + index">{{ item }}</li>
...
.icon-keyboard-xiangshang {
  background: url('data:image/png;base64,') no-repeat center/80%;
}
.icon-keyboard-shanchu {
  // background: url('data:image/png;base64,') no-repeat 0 0/cover;
...
// @import "../assets/profile/icon/iconfont.scss";
@keyframes blink {
 0%{
   opacity: 0;
 }
